...
(function() {
    ...
    var fontA = new FontFaceObserver("Graphik Web");
    var fontB = new FontFaceObserver("Graphik Web", {
        weight: 500
    });
    var fontC = new FontFaceObserver("Graphik Web", {
        weight: 600
    });
    var fontD = new FontFaceObserver("Graphik Web", {
        weight: 700,
    });
